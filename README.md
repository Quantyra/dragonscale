...
- `docs/`: operating, OAuth, cutover, and Kuzuryu private-access runbooks.
...
6. Validate with:
   ...
   ```powershell
   powershell -NoProfile -ExecutionPolicy Bypass -File scripts/smoke-dragonscale.ps1 -BaseUrl https://dragonscale.kuzuryu.ai
